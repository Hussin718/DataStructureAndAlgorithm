...
بعد تشغيل البرنامج، ستجد ملف `maze_solution.png` في مجلد المشروع يوضح المسار المكتشف باللون (غالباً الأحمر أو الأخضر حسب إعداداتك في `MazeImageGenerator`).

---

**هل تود مني إضافة قسم خاص بشرح كيفية عمل خوارزمية A* بالتحديد داخل الكود الخاص بك؟** Maven
